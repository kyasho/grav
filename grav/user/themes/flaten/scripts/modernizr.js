/*!
 * modernizr v3.5.0
 * Build https://modernizr.com/download?-backdropfilter-cssanimations-prefixed-printshiv-setclasses-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
        ...
        for (nameIdx = 0; nameIdx < featureNames.length; nameIdx++) {
          ...
          if (featureNameSplit.length === 1) {
            ...
            if (Modernizr[featureNameSplit[0]] && !(Modernizr[featureNameSplit[0]] instanceof Boolean)) {
              Modernizr[featureNameSplit[0]] = Modernizr[featureNameSplit[0]];
            }
