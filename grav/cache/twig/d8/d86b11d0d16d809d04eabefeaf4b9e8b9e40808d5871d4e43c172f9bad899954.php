...
class __TwigTemplate_fa93a17382a0f7c6c43ce3b5fd9faf7b5ecb72d4d1a4b97382c9374382e58f63 extends Twig_Template
{
    ...
    ";
        ...
        <tr data-gpm-plugin=\"";
            ...
            if ($this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "isPremiumProduct", array(0 => $context["plugin"]), "method")) {
                ...
                echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PREMIUM_PRODUCT"), "html", null, true);
                echo "</span></small>
                ";
            }
            // line 36
...
(isset($context["installing"]) ? $context["installing"] : null)) {
                ...
                if (($this->getAttribute($context["plugin"], "premium", array()) &&  !$this->getAttribute((isset($context["admin"]) ? $context["admin"] : null), "license", array(0 => $this->getAttribute($context["plugin"], "slug", array())), "method"))) {
                    ...
                    echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("Buy Now"), "html", null, true);
                    echo "</a>
                    ";
                } else {
                    // line 57
    ...
    ";
        ...
        if (!$context['_iterated']) {
            // line 69
            echo "        <tr><td>";
            echo twig_escape_filter($this->env, $this->env->getExtension('AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.OFFLINE_WARNING"), "html", null, true);
            echo "</td></tr>
    ";
        }
