...
class __TwigTemplate_117634a95b7ebb944d3508ccd3146ff3506c045c4ab67a32e8b1eb6ec5b791e4 extends Twig_Template
{
    ...
    ";
        ...
        ";
            ...
            echo $this->getAttribute((isset($context["page"]) ? $context["page"] : null), "url", array());
            echo "\">";
            echo $this->env->getExtension('GravTwigExtension')->translate("Continue Reading");
            echo "</a></p>
        </div>
    ";
        } elseif (        // line 58
    ...
    ";
        ...
        <p class=\"prev-next\">
            ...
            if ( !$this->getAttribute((isset($context["page"]) ? $context["page"] : null), "isFirst", array())) {
                ...
                echo $this->env->getExtension('GravTwigExtension')->translate("Next Post");
                echo "</a>
            ";
            }
            // line 81
            ...
            if ( !$this->getAttribute((isset($context["page"]) ? $context["page"] : null), "isLast", array())) {
                ...
                echo "\">";
                echo $this->env->getExtension('GravTwigExtension')->translate("Previous Post");
